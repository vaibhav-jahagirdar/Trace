...
> Backend Engineer with 2 years of experience at ABC Technologies. Built authentication services using JWT, Refresh Token Rotation, Replay Detection, Redis and BullMQ. Developed OrgOps using Node.js, PostgreSQL and Redis with RBAC, Audit Logging and Database Transactions. B.Tech Computer Science.
...
metadata:
  schema_version: "1.0"
  extraction_timestamp: "2026-07-11T10:15:00Z"
  parser_version: "pdf-resume-parser-1.2"
...
profile:
  ...
  claimed_total_experience_years: 2
  summary: "Backend Engineer with 2 years of experience at ABC Technologies."
  summary_claim_id: claim_0001
...
work_experiences:
  - claim_id: claim_0002
    ...
    achievements: []
    technologies:
      - claim_0006   # Node.js (registry entry, defined below)
      - claim_0007   # Redis
      - claim_0008   # BullMQ
    concepts:
      - claim_0009   # Refresh Token Rotation
      - claim_0010   # Replay Detection
    implementation_claims:
      - claim_id: claim_0003
        text: "Built authentication services using JWT."
        confidence: HIGH
      ...
      - claim_id: claim_0004
        ...
        explicit_or_inferred: EXPLICIT
      - claim_id: claim_0005
        text: "Implemented replay detection."
        confidence: HIGH
        explicit_or_inferred: EXPLICIT
    source_text: "Built authentication services using JWT, Refresh Token Rotation, Replay Detection, Redis and BullMQ."
    confidence: HIGH

projects:
  - claim_id: claim_0011
    title: OrgOps
    description: "Org management service."
    technologies:
      - claim_0006   # Node.js (same registry entry, reused via source_claim_ids)
      - claim_0012   # PostgreSQL
      - claim_0007   # Redis (reused)
    concepts:
      - claim_0013   # RBAC
      - claim_0014   # Audit Logging
      - claim_0015   # Database Transactions
    implementation_claims:
      - claim_id: claim_0016
        text: "Implemented RBAC, audit logging, and database transactions."
        confidence: HIGH
        explicit_or_inferred: EXPLICIT
    architectural_claims: []
    major_features: []
    source_text: "Developed OrgOps using Node.js, PostgreSQL and Redis with RBAC, Audit Logging and Database Transactions."
    confidence: HIGH
...
technologies:
  - claim_id: claim_0006
    ...
    raw_name: Node.js
    source_claim_ids: [claim_0002, claim_0011]
    confidence: HIGH
    explicit_or_inferred: EXPLICIT
    contexts: [Work Experience, Project]
  ...
  - claim_id: claim_0008
    normalized_name: BullMQ
    raw_name: BullMQ
    source_claim_ids: [claim_0002]
    confidence: HIGH
    explicit_or_inferred: EXPLICIT
    contexts: [Work Experience]

  - claim_id: claim_0012
    normalized_name: PostgreSQL
    raw_name: PostgreSQL
    source_claim_ids: [claim_0011]
    confidence: HIGH
    explicit_or_inferred: EXPLICIT
    contexts: [Project]
...
concepts:
  - claim_id: claim_0009
    normalized_name: Refresh Token Rotation
    raw_name: Refresh Token Rotation
    source_claim_ids: [claim_0004]
    confidence: HIGH
    explicit_or_inferred: EXPLICIT
    contexts: [Work Experience]

  - claim_id: claim_0010
    normalized_name: Replay Detection
    raw_name: Replay Detection
    source_claim_ids: [claim_0005]
    confidence: HIGH
    explicit_or_inferred: EXPLICIT
    contexts: [Work Experience]
  ...
  - claim_id: claim_0013
    ...
    raw_name: RBAC
    source_claim_ids: [claim_0016]
    confidence: HIGH
    explicit_or_inferred: EXPLICIT
    contexts: [Project]

  - claim_id: claim_0014
    normalized_name: Audit Logging
    raw_name: Audit Logging
    source_claim_ids: [claim_0016]
    confidence: HIGH
    explicit_or_inferred: EXPLICIT
    contexts: [Project]
  ...
  - claim_id: claim_0015
    normalized_name: Database Transactions
    raw_name: Database Transactions
    source_claim_ids: [claim_0016]
    confidence: HIGH
    explicit_or_inferred: EXPLICIT
    contexts: [Project]
